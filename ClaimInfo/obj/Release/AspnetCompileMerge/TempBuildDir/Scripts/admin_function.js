...
/*when click on search box and search in table start*/
$(document).ready(function () {

    //New Search Fuctionality
    var table = $('#tblId').DataTable({
        ...
        language: {
            paginate: {
                //next: '<img src="../Images/calright.png">',
                //previous: '<img src="../Images/calleft.png">'
                next: '>',
                previous: '<'
            }
        }
    ...
    var table2 = $('#upcomingtblId, #tblIdUrgent').DataTable({
        "pageLength": 5,
        //"pagingType": "simple",
        "pagingType": "simple_numbers",
        "ordering": false,
...
/*when click on search box and search in table end*/
